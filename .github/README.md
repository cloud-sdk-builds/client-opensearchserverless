...
[`@aws-sdk/client-opensearchserverless`](https://www.npmjs.com/package/@aws-sdk/client-opensearchserverless/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearchserverless@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-sD5H+vMdsC9ZSvqoqvR++ZYMgvfQuiVCcfQsWIcxGnYlmZzE/IdSnfDB1nnDd574
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-opensearchserverless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearchserverless@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-opensearchserverless@3.876.0/index.min.mjs": "sha384-sD5H+vMdsC9ZSvqoqvR++ZYMgvfQuiVCcfQsWIcxGnYlmZzE/IdSnfDB1nnDd574"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-opensearchserverless/blob/refs/tags/3.876.0/LICENSE
```
